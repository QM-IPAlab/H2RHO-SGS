#use project's original dataset to render
#python render_original.py  --source_path dataset/fern --model_path output/fern  --eval  --n_views 3 --depth_pseudo_weight 0.03
import copy
