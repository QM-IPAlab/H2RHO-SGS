...
des_dir = '/home/e/eez095/project/motion/data/seen/obj6/5'
os.makedirs(des_dir,exist_ok=True)
output_file = f"{des_dir}/log.txt"
policy = 'policy_v12_T_norm'
src_path = '/home/e/eez095/dexycb_data/20200813-subject-02/20200813_150823/36_frame'
model_path = '/home/e/eez095/project/policy_learning/model/0310_norm_v6000_obj23unseen.pth'
hand_ply_file = f'{src_path}/handover_3D/hand.ply'
obj_ply_file = f'{src_path}/handover_3D/object.ply'
ini_test_img_path = '/home/e/eez095/dexycb_data/20200813-subject-02/20200813_150823/36_frame/FSGS_output/video/sample_v610000/14/14_0.png'
ini_test_traj_path = f'{src_path}/trajectory_v6/14/14_0.npy'
pre_grasp_path = f'{src_path}/trajectory_v6/14/14_22.npy'
first_pth = f'{des_dir}/1.npy'
grasp_pose_file = f'{src_path}/trajectory_v6/14/14_target.npy'
...
command3 = f""" 
            python dis_grasp.py \
            --predict_grasp_file {des_dir}/21.npy \
            --gt_pregrasp_pose_file {pre_grasp_path}  \
